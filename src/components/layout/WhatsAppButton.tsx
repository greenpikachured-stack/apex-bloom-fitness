...
export const WhatsAppButton = () => {
  return (
    <a
      ...
      className="group fixed bottom-4 right-4 z-[9999] flex h-14 w-14 items-center justify-center rounded-full transition-all duration-300 hover:scale-[1.06] active:scale-95 md:bottom-6 md:right-6"
    >
      ...
      <span className="relative flex h-full w-full items-center justify-center text-white">
        <svg
          ...
          role="img"
          aria-hidden="true"
          className="h-7 w-7 fill-current drop-shadow-[0_1px_2px_rgba(0,0,0,0.35)]"
        >
